...
import { removeToCart } from "../../pages/store/slice/CartSlice";
        ...
        <div className="cart-section">
            ...
            <Container>
                <Box style={{float:"right"}}>
                    <Link className='btn btn-custom' to='/'>Product page</Link>
                </Box>
                <Grid container spacing={3} sx={{ pr: 2, mb: 5, mt: 2 }}>
                    <Grid item xs={12} sm={12} md={8}>
                        <Box>
                            {getproducts.map((item) => (
                                <Box key={item.id} style={{ backgroundColor: '#ffffff' }} className="px-3">
                                    <Grid container spacing={2} className='mt-3' key={item.id} >
                                        ...
                                        >
                                            <Grid item xs>
                                                <Typography variant="body2" className="fw-bold" gutterBottom>
                                                    {item.title}
                                                </Typography>
                                            </Grid>
                                            <Grid item xs
                        ...
                        >
                            <CardContent>
                                <Stack
                                    ...
                                    sx={{ justifyContent: "space-between" }}
                                >
                                    <Typography color="text.secondary" className="fw-bold">Sub total</Typography>
